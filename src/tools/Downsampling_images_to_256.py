    ...
    def read_all_files(self, read_path, write_path, resize_with_pad=True):
        for file in os.listdir(read_path):
            ...
            if file.endswith(".jpeg"):
                ...
                final_resized_image.save(
                    write_path + "/resized_" + fileName + ".jpg",
                    dpi=(500, 500),
                    quality=500,
                )
...
def main():
    ...
    read_minutiae_map_folder_path_20 = (
        "../../data/initial_Pre_Process_data/Minutiae/minutiaeMaps20"
    )
    write_minutiae_map_folder_path_20 = (
        "../../data/initial_Pre_Process_data/Minutiae/minutiaeMaps20_256"
    )

    read_minutiae_map_folder_path_40 = (
        "../../data/initial_Pre_Process_data/Minutiae/minutiaeMaps40"
    )
    write_minutiae_map_folder_path_40 = (
        "../../data/initial_Pre_Process_data/Minutiae/minutiaeMaps40_256"
    )
