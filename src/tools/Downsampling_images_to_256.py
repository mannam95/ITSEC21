...
def main():
  read_minutiae_map_folder_path = '../../data/initial_Pre_Process_data/FingerPrints/minutiaeMaps'
  write_minutiae_map_folder_path = '../../data/initial_Pre_Process_data/FingerPrints/Minutiae_Map_Images_256'
